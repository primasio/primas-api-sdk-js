...
describe('content test', () => {
  ...
  describe('form', () => {
    ...
    test('update html content', done => {
      form.Content.update('ba6f8c9214be28655b52a07e96164262bb90d52b070355702b88fa7e336f5a3b', {
        tag: 'article',
        parent_dna: "a562f4d9a0480d63c456a24f7aae8f8c9f4d9a7017646e844d23585096dec15b",
        title: 'test',
        abstract: 'this is a test account',
        language: 'en',
        category: 'test',
